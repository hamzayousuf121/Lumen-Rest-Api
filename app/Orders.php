...
class Orders extends Model
{
    ...
    protected $fillable = [
        'total_amount', 'dis_amount', 'grand_total', 'customer_id',
        'supplier_id', 'user_id', 'description', 'recieved_amount', 'balance', 'status'
    ];
    ...
    static public function search($request)
    {
        ...
        $query = Orders::select([
            'total_amount', 'dis_amount', 'grand_total', 'customer_id', 'supplier_id',
            'user_id', 'description', 'recieved_amount', 'balance', 'status'
        ]);
        //->limit($limit)
        //->offset($offset);
